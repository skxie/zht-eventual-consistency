...
const string Const::ZC_PORT_DIFFERENTIAL = "PORT_DIFFERENTIAL";
...
const string Const::ZSC_OPC_REMOVE_SELF = "102";
const string Const::ZSC_OPC_INSERT = "003";
const string Const::ZSC_OPC_INSERT_SELF = "103";
...
const string Const::ZSC_OPC_EXISTS = "008";
